{{--
 ...
 | Role-aware: staff / approver / admin_ga
--}}
    ...
    <div class="min-h-screen bg-gray-50 pb-16" x-data="helpPage()" x-init="init()">
        ...
        <div class="help-header">
            <div class="max-w-3xl mx-auto px-4 py-10 text-center">
                ...
                {{-- Role badge --}}
                <div class="mt-3 inline-flex items-center gap-2 px-3 py-1 rounded-full
        ...
        <div class="max-w-3xl mx-auto px-4 mt-8">
            ...
            <div class="help-tabs" x-show="!search">
                <button
                    ...
                    :class="activeSection === 'all' ? 'help-tab-active' : 'help-tab'"
                    class="help-tab-base">
                    Semua
                </button>
                <template x-for="sec in sections" :key="sec.id">
                    <button
                        ...
                        :class="activeSection === sec.id ? 'help-tab-active' : 'help-tab'"
                        class="help-tab-base"
                        x-text="sec.title">
                    </button>
                </template>
            ...
            <div class="space-y-8 mt-4">
                    ...
                    <div :id="'sec-' + sec.id">
                        ...
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <span class="text-xs text-gray-400"
                                  x-text="sec.items.length + ' pertanyaan'"></span>
                        </div>
                        ...
                        <div class="space-y-2">
                            <template x-for="(item, idx) in sec.items" :key="sec.id + '-' + idx">
                                <div class="help-faq-item"
                                     :class="isOpen(sec.id, idx) ? 'help-faq-item--open' : ''">

                                    {{-- Question --}}
                                    <button
                                        @click="toggle(sec.id, idx)"
                                        class="help-faq-q group">
                                        ...
                                        <span class="help-faq-chevron"
                                              :class="isOpen(sec.id, idx) ? 'rotate-180' : ''">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                      d="M19 9l-7 7-7-7"/>
                                            </svg>
                ...
                {{-- Empty state --}}
                <div x-cloak x-show="filteredSections().length === 0"
                    ...
                    <button @click="search = ''"
                            class="mt-4 text-xs font-medium text-blue-600 hover:text-blue-700">
                        Hapus pencarian
                    </button>
                </div>
